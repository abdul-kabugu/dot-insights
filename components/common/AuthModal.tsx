...
const panelStyles = cva(
  cx(
    'relative w-full rounded-[20px] bg-gray-900',
    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo='opacity-0'
        >
          <div className='fixed inset-0 bg-black bg-opacity-35 backdrop-blur-sm' />
        </Transition.Child>
              ...
              >
                ...
                >
                  {withCloseButton && !onBackClick && (
                    <Button
                      className='absolute right-6 m-1 mr-0 p-0 text-2xl text-gray-400'
                      variant='transparent'
                      onClick={closeModal}
                    >
                      <HiXMark />
               ...
               { withFooter && (
                  <div className='flex items-center justify-center gap-4 border-t border-gray-700 px-6 py-5 text-sm text-gray-400'>
                    <p
                    >
                      Privacy Policy
                    </p>
